                                ...
                                <div class="mt-1 absolute bottom-1 left-0 right-0 px-1 text-xs space-y-0.5">
                                    <?php $__currentLoopData = $approvedBookings[$dayKey]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p class="bg-green-200 text-green-800 rounded px-1 py-0.5 truncate text-center"
                                           title="<?php echo e($booking['room']); ?> (<?php echo e($booking['start_date']); ?> - <?php echo e($booking['end_date']); ?>) - <?php echo e($booking['borrower']); ?>: <?php echo e($booking['purpose']); ?>">
...
<?php if(auth()->user()->first_login): ?>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        introJs().setOptions({
            steps: [
                { intro: "👋 Selamat datang di Ruang Fasilkom!" },
                { element: document.querySelector('[href="<?php echo e(route("rooms.index")); ?>"]'), intro: "🎯 Gunakan tombol Start Quest untuk memesan ruangan." },
            ...
            fetch("<?php echo e(route('user.complete-onboarding')); ?>", {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\intan\Downloads\ruangfasilkom22\resources\views/user/home.blade.php ENDPATH**/ ?>